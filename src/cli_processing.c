...
struct argp_option options[] = {
    ...
    {"lin", 'l', "LINES", 0, "Number of lines for the environment when it is being created. This number includes the surrounding walls.",6},
    {"col", 'c', "COLUMNS", 0, "Number of columns for the environment when it is being created. This number includes the surrounding walls."},
...
void extract_full_command(char *full_command, int key, char *arg)
{
    ...
    switch(key)
    {
        ...
        case OPT_STEP_VALUE:
            ...
            break;
        case OPT_DYN_FIELD_DEFINITION:
            sprintf(aux, " --dyn-definition=%s", arg);
            break;
        case OPT_STATIC_FIELD:

...
for ambient in "daniel_anfiteatro_fogo_centro" "daniel_anfiteatro_fogo_superior" "daniel_anfiteatro_fogo_porta_esquerda" "daniel_anfiteatro_fogo_duas_portas"; do
    ...
    $RUN_COMMAND -o$dir_name/fire_experiment_$ambient.txt -m4 -e$ambient.txt -O1 -s1 --static-field=5 --kf=500 --ks=2 --kd=1 --delta=0.3 --alpha=0.3 --ignore-self-trace  --skip-new-particles-decay --allow-diagonal-movements --cooldown=5 --traversability=0.7
done
